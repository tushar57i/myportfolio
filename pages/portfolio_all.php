            ...
            <div class="container">
              ...
              <hr>
                <div class="row articles">
                    <div class="col-sm-6 col-md-4 item border rounded"><a href="#"><img class="img-fluid" src="../img/desk.jpg"></a>
                        <h3 class="name">Article Title</h3><hr>
...
<!-- Footer -->
        <footer class="text-center text-white">
            <div class="bg-dark" style="padding: 10px;">
                <h5 class="text-center">Copyright &copy; 2020<br><a href="https://fb.me/tushar57i" class="link">Tushar</a></h5>
            </div>
        </footer>
<!-- Footer End -->
<!-- JS -->
